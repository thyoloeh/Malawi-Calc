          ...
          <div className="p-4 border-b border-[#2C2C2E] flex flex-col gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-[#1C1C1E] border border-[#2C2C2E] rounded-full text-xs sm:text-sm text-white placeholder-[#8E8E93] focus:outline-none focus:border-[#FF9F0A] font-sans"
              />
              {searchQuery && (
                <button
                  type="button"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <span className={`px-2.5 py-0.5 rounded-full text-[11px] font-mono font-bold border uppercase tracking-wider ${typeStyle.color}`}>
                        {typeStyle.label}
                      </span>
                    ...
                    <div className="flex flex-col gap-0.5">
                      <span className="font-mono text-xs sm:text-sm text-[#8E8E93] truncate">
                        {item.expression}
                      </span>
                      <span className="font-mono text-lg sm:text-xl font-bold text-white break-words">
                        = {item.result}
                      </span>
                    </div>
                    ...
                    {/* Optional details */}
                    {item.details && (
                      <span className="text-xs text-gray-300 bg-black/60 p-2.5 rounded-2xl border border-[#2C2C2E] font-sans leading-relaxed">
                        {item.details}
                      </span>
                    )}
                    ...
                    <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#2C2C2E]">
                      <button
                        ...
                        title="Copy Result"
                        className="p-2.5 rounded-full bg-[#242424] hover:bg-[#333333] text-gray-300 hover:text-white transition-colors"
                      >
                        {copiedId === item.id ? (
                      ...
                      <button
                        ...
                        className="p-2.5 rounded-full bg-[#FF9F0A]/20 hover:bg-[#FF9F0A]/30 text-[#FF9F0A] border border-[#FF9F0A]/30 transition-colors"
                      >
                      ...
                      <button
                        ...
                        title="Delete Item"
                        className="p-2.5 rounded-full bg-[#FF453A]/20 hover:bg-[#FF453A]/30 text-[#FF453A] transition-colors"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
